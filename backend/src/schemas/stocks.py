...
class IndexQuote(BaseModel):
    symbol: str                          # Yahoo symbol, e.g. ^GSPC / ^NSEI
    name: str                            # display name, e.g. "S&P 500"
    region: str                          # "US" | "IN"
    last: float                          # latest daily close
    change: Optional[float] = None       # vs previous close
    change_pct: Optional[float] = None   # % vs previous close
    points: List[IndexPoint]             # ~3 months of daily closes for sparklines
